...
def make_output_path(N_agent):
    path = "output/RSshare/{}_agents" .format(N_agent)
...
def train(env, SIMULATION_TIMES, EPISODE_TIMES, output_path):
    ...
    for _ in range(N_agent):
        player.append(model_RS.RS(lr, dr, aleph, tau_alpha, tau_gamma, env.num_state, num_action=env.num_action))
